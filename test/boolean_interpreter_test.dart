  ...
  group('RhapsodyInterpreter', () {
    test('evaluates dependent rules and updates ruleState', () {
      ...
      final List<RhapsodyToken> tokens = [
        ...
        t.token("env", TokenTypes.identifier),
        t.token(":", TokenTypes.colon),
        t.token("variable_4", TokenTypes.identifier),
        t.token(")", TokenTypes.rparen),
        t.token(";", TokenTypes.semicolon),
      ];
      ...
      builder.setRefValue('env:variable1:blue', 'func1');
      builder.setRefValue('env:variable_4', 'func2');
      ...
      // ---
      context.variables.set('env:variable_4', 'other');
      interpreter.interpret(context);
